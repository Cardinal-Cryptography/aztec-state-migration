...
siloed    = poseidon2_hash_with_separator([old_app_address, note_hash], GENERATOR_INDEX__SILOED_NOTE_HASH)
...
1. ~~Finalize portal message encoding / hashing for `(old_rollup_version, archive_root, proven_block_number)`.~~ Done.
